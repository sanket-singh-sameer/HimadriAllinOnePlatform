              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 mb-12 sm:mb-16">
                <div className="sm:col-span-2 lg:col-span-2">
                  ...
                  <p className="!text-base sm:!text-lg !text-gray-300 !opacity-90 !leading-relaxed mb-6 sm:mb-8 !text-left">
                    Making hostel life simpler, smarter, and more connected
                    through technology built by students, for students.
                  </p>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
                    <div className="text-left">
                      ...
                      <p className="!text-lg !text-gray-300 !opacity-100 !leading-relaxed mb-8 !text-left">
                        ...
                        students who understand the real challenges of hostel
                        life. Every feature is crafted with genuine student
                        experiences in mind.
                      </p>
