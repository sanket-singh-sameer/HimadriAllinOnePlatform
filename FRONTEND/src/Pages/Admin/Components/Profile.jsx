                          ...
                          <div className="p-6 sm:p-8">
                            ...
                            <div className="flex bg-gray-100 rounded-xl p-1 mb-4 sm:mb-6">
                              <button
                                ...
                                className={`cursor-pointer flex-1 py-2.5 px-4 rounded-lg font-semibold text-sm transition-all duration-300 flex items-center justify-center gap-2 ${activeTab === "profile"
                              ...
                              <button
                                ...
                                className={`cursor-pointer flex-1 py-2.5 px-4 rounded-lg font-semibold text-sm transition-all duration-300 flex items-center justify-center gap-2 ${activeTab === "password"
                                    ? "bg-white text-gray-900 shadow-sm"
                                    : "text-gray-600 hover:text-gray-900"
                                  }`}
                              >
