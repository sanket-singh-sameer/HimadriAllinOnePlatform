                              ...
                              paginatedComplaints.map((complaint, index) => (
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <span
                                      className={`self-start sm:self-center text-xs sm:text-sm font-medium px-3 sm:px-4 py-1 sm:py-1.5 rounded-full shadow-sm min-w-fit ${complaint.status === "Resolved"
                                  ...
                                  <div
                                    className={`transition-all duration-700 overflow-hidden ${openIndex === index
                                  ...
                                  if (
                                    ...
                                    return (
                                      <button
                                        ...
                                        className={`px-4 py-2 rounded-lg border transition-colors ${complaintsCurrentPage === pageNumber
