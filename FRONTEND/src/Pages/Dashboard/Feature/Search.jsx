                        ...
                        <div className="space-y-3">
                          <div className="flex items-center gap-4 !pb-3 border-b border-gray-100">
                            ...
                            <div className="flex-1">
                              <div className="!text-base !font-bold !text-gray-900 !mb-1">{studentDetails.name || "N/A"}</div>
                            </div>
                          </div>
                          <div className="space-y-2">
                            <div className="flex items-start justify-between !py-2">
                              <span className="!text-xs !font-medium !text-gray-500 !uppercase !tracking-wide">Roll Number</span>
                              <span className="!text-sm !font-semibold !text-gray-900">{studentDetails.roll || "N/A"}</span>
                            </div>
                            <div className="flex items-start justify-between !py-2 !border-t !border-gray-100">
                              ...
                              <span className="!text-sm !font-semibold !text-gray-900 !text-right !max-w-[180px]">{studentDetails.fatherName || "N/A"}</span>
                            </div>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="!px-6 !py-6 align-top">
                        <div className="space-y-3">
                          <div className="flex items-center gap-4 !pb-3 border-b border-gray-100">
                            ...
                            <div>
                              <div className="!text-xs !font-bold !text-gray-900 !uppercase !tracking-wide">CGPA Score</div>
                              <div className="!text-xs !text-gray-500 !mt-0.5">Current Performance</div>
                            </div>
                          </div>
                          <div className="space-y-2">
                            <div className="flex items-center justify-between !py-2">
                              ...
                              <div className="flex items-center gap-2">
                                <div
                                  className={`!w-2.5 !h-2.5 !rounded-full ${parseFloat(studentDetails.cgpi) >= 8.5 ? "!bg-gray-900" : parseFloat(studentDetails.cgpi) >= 7.0 ? "!bg-gray-600" : "!bg-gray-400"}`}
                                ></div>
                                <span className="!text-sm !font-semibold !text-gray-900">
                                  {parseFloat(studentDetails.cgpi) >= 8.5 ? "Excellent" : parseFloat(studentDetails.cgpi) >= 7.0 ? "Good" : "Average"}
                                </span>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="space-y-3">
                          <div className="flex items-start justify-between !py-2.5 !px-3 !bg-gray-50 !rounded-lg !border !border-gray-200">
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                <div className="!text-xs !font-medium !text-gray-500 !uppercase">Room Number</div>
                                <div className="!text-sm !font-bold !text-gray-900">{studentDetails?.room || "N/A"}</div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start justify-between !py-2.5 !px-3 !bg-gray-50 !rounded-lg !border !border-gray-200">
                            <div className="flex items-center gap-2">
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="!text-xs !font-medium !text-gray-500 !uppercase">Email Address</div>
                                <div className="!text-sm !font-bold !text-gray-900 !truncate">{`${studentDetails.roll}@nith.ac.in` || "N/A"}</div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start justify-between !py-2.5 !px-3 !bg-gray-50 !rounded-lg !border !border-gray-200">
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                ...
                                <div className="!text-sm !font-bold !text-gray-900">{studentDetails?.phone || "N/A"}</div>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <td colSpan="3" className="!px-6 !py-12 !text-center">
                        <div className="flex flex-col items-center space-y-4">
                          ...
                          <div className="text-center">
                            <h3 className="!text-lg !font-bold !text-gray-900 !mb-2">No Student Found</h3>
            ...
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4 border border-gray-200">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium text-gray-700">Complete student profile information</span>
                </div>
